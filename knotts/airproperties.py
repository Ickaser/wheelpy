...
DIPPR(R) Public database [1], and the DIPPR(R) abbreviations are used.       
...
al. [2] Density-related properties for the vapor phase use the DIPPR(R)      
...
# critical volume
vc = 0.00009147 # units of m**3/mol
